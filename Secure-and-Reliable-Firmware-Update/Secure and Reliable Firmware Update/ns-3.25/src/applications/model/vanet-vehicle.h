...
/* 
 * File:   vehicle-packet-sink.h
 * Author: samet
 *
 * Created on August 30, 2016, 3:10 PM
 */

#ifndef VANET_VEHICLE_H
#define VANET_VEHICLE_H
 ...
 */
class VANETVehicle : public Application
{
public:
  static TypeId GetTypeId (void);
  VANETVehicle ();
  VANETVehicle (uint16_t port, Address local, uint32_t delay);

  virtual ~VANETVehicle ();

...
public:
   ...
   *
   */
  VanetPacketSinkHelper (Address listenEV, Address address, Address target, uint32_t processingDelay);  
  ...
  VanetPacketSinkHelper (Address listenEV, Address local, uint32_t processingDelay);
